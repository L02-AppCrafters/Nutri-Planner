 ...
 * along with a brief explanation and the option to navigate to the
 * Dashboard or re-enter data.
 */
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          testID="btn-go-to-dashboard"
        >
          <Text style={styles.dashboardButtonText}>Xem Bảng Điều Khiển →</Text>
        </TouchableOpacity>
